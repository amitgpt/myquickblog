...
<div id="index-banner" class="parallax-container">
    <div class="section no-pad-bot">
      <div class="container">
        <br><br>
        <h1 class="header center teal-text text-lighten-2">@if(isset($postid->title)){{$postid->title}}@else Man must explore, and this is exploration at its greatest @endif</h1>
        <div class="row center">
          <h5 class="header col s12 light">@if(isset($postid->sub_title)){{$postid->sub_title}}@else Problems look mighty small from 150 miles up @endif</h5>
        </div>
        <br><br>
    ...
    <div class="section">
      ...
      <div class="row">
        <div class="col s12 center">
          <p class="left-align light">@if(isset($postid->content)){{--*/echo $postid->content/*--}}@else Never in all their history have men been able truly to conceive of the world as one: a single sphere, a globe, having the qualities of a globe, a round earth in which all the directions eventually meet, in which there is no center because every point, or none, is center — an equal earth which all men occupy as equals. The airman's earth, if free men make it, will be truly round: a globe in practice, not in theory.
...
<h2>Reaching for the Stars</h2><p>As we got further and further away, it [the Earth] diminished in size. Finally it shrank to the size of a marble, the most beautiful you can imagine. That beautiful, warm, living object looked so fragile, so delicate, that if you touched it with a finger it would crumble and fall apart. Seeing this has to change a man.</p>
<div><img src="/assets/front_end/material/img/post-sample-image.jpg"></div>
...
Placeholder text by Space Ipsum. Photographs by NASA on The Commons. @endif</p>
        </div>
      </div>
