...
window.onload = function() {
  ...
  CKFinder.SetupCKEditor( editor, '/ckfinder/');
      ...
      <div class="container">
        <div class="section">
			 <!-- Modal Trigger -->
			  <a class="btn-floating btn-large waves-effect waves-light modal-trigger right" href="#modal1" id="btnabout"><i class="mdi-content-add"></i></a>
			  <!-- Modal Structure -->
			  <div id="modal1" class="modal mymodal">
				...
				<div class="modal-content">
				   <h4 class="center">About Content</h4>
					  <div class="row">
